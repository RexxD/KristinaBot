...
import html
import requests
import KristinaBot.modules.sql.kuki_sql as sql

from time import sleep
from telegram import ParseMode
from KristinaBot import dispatcher, updater, SUPPORT_CHAT
...
from KristinaBot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Kristina Chatbot disable by {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Kristina Chatbot enable by {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
